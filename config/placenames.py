...
datameet_state_col_name = "ST_NM"
datameet_district_col_name = "DISTRICT"

#     chosen_states = ['AP','TG','MH','KA','BR','CG','JH','WB']  # Other states
ST_list = {
    'AN': ['Andaman & Nicobar Island'],
    'AP': ['Andhra Pradesh'],
    ...
    'CH': ['Chandigarh'],
    'DD': ['Daman & Diu'],
    'DL': ['NCT of Delhi', 'Delhi'],
    'DN': ['Dadara & Nagar Havelli', 'Dadra and Nagar Hav', 'DH'],
    'GA': ['Goa'],
    'GJ': ['Gujarat'],
    'HP': ['Himachal Pradesh'],
    'HR': ['Haryana'],
